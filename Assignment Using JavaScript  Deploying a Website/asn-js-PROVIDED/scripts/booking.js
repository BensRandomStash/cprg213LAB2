...
const calculatedCostEI = document.getElementById('claculated-cost');
...
function onWednesdayButton(e) {
    ...
    setButtonStates(wednesdayButton);
}
...
function onThursdayButton(e) {
    ...
    setButtonStates(thursdayButton);
}
...
clearButton.onclick = function(e) {
    ...
    resetHalfFullClearButtonStates();
...
function recalculate() {
    calculatedCostEI.textContent = costPerDay.toFixed(2);
}
